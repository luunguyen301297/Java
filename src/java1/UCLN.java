...
//      }
//    }
//    System.out.println(String.format("Java1.UCLN of %d and %d is  %d", a, b, Java1.UCLN));

//    C2:
    System.out.println((a > b) ? "Java1.UCLN : " + NumberUtils.findUCLN(a, b) : "Java1.UCLN : " + NumberUtils.findUCLN(b, a));
  }
}
