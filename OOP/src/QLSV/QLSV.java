...
public class QLSV {
    ...
    do {
      ...
      switch (choose) {
        ...
        case 3:
          ...
          System.out.println("Student have maxAvgScore :");
          studentList.get(maxIndex).showInfo();

          System.out.println("Student have minAvgScore :");
  ...
  static void showMenu() {
    ...
    System.out.println("5. Display All Student & Sort name A-Z");
    System.out.println("6. Display All Student have scholarships & Sort avgScore Max-Min");
